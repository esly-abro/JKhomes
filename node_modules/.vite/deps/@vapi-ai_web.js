...
function B(e2) {
  return null != e2 && e2.callObjectBundleUrlOverride ? e2.callObjectBundleUrlOverride : F("https://c.daily.co/call-machine/versioned/".concat("0.85.0", "/static/call-machine-object-bundle.js"), e2);
}
function U(e2) {
  try {
    new URL(e2);
...
function le() {
  ce = $.onerror, $.onerror = function(e2, t2, n2, r2, i2) {
    return ae("error", { column: r2, error: i2, line: n2, msg: e2, url: t2 }), !!ce && ce.apply(this, arguments);
...
function Oe(e2, t2 = {}) {
  ...
  try {
    ...
    for (; n2 && o2++ < r2 && (l2 = Pe(n2, u2), !("html" === l2 || o2 > 1 && s2 + i2.length * c2 + l2.length >= d2)); ) i2.push(l2), s2 += l2.length, n2 = n2.parentNode;
...
function Pt(e2) {
  ...
  try {
    ...
    if ((function(e3) {
      ...
      return Ve({ span_id: t2, trace_id: n2, data: r2, description: o2, parent_span_id: a2, start_timestamp: Tt(i2), timestamp: Tt(s2) || void 0, status: At(c2), op: r2["sentry.op"], origin: r2["sentry.origin"], _metrics_summary: wt(e2) });
    }
...
function Bt(e2) {
  const t2 = "string" == typeof e2 ? (function(e3) {
    ...
    return Ft({ host: o2, pass: i2, path: c2, projectId: l2, port: s2, protocol: n2, publicKey: r2 });
  })(e2) : Ft(e2);
  if (t2 && (function(e3) {
    if (!z) return true;
...
function Zt(e2, t2, n2, r2 = 0) {
  return new et(((i2, o2) => {
    ...
    if (null === t2 || "function" != typeof s2) i2(t2);
      ...
      const a2 = s2({ ...t2 }, n2);
      V && s2.id && null === a2 && Q.log(`Event processor "${s2.id}" dropped event`), Me(a2) ? a2.then(((t3) => Zt(e2, t3, n2, r2 + 1).then(i2))).then(null, o2) : Zt(e2, a2, n2, r2 + 1).then(i2).then(null, o2);
    }
  }));
}
function rn(e2, t2) {
  ...
  !(function(e3, t3) {
    const { extra: n3, tags: r3, user: i3, contexts: o3, level: s2, transactionName: a2 } = t3, c2 = Ve(n3);
...
function on(e2, t2) {
  ...
  sn(e2, "extra", n2), sn(e2, "tags", r2), sn(e2, "user", i2), sn(e2, "contexts", o2), e2.sdkProcessingMetadata = ot(e2.sdkProcessingMetadata, a2, 2), s2 && (e2.level = s2), h2 && (e2.transactionName = h2), f2 && (e2.span = f2), c2.length && (e2.breadcrumbs = [...e2.breadcrumbs, ...c2]), l2.length && (e2.fingerprint = [...e2.fingerprint, ...l2]), u2.length && (e2.eventProcessors = [...e2.eventProcessors, ...u2]), d2.length && (e2.attachments = [...e2.attachments, ...d2]), e2.propagationContext = { ...e2.propagationContext, ...p2 };
}
...
function dn(e2) {
  const t2 = bt(), n2 = yt(), r2 = mt(), { release: i2, environment: o2 = xt } = t2 && t2.getOptions() || {}, { userAgent: s2 } = $.navigator || {}, a2 = tt({ release: i2, environment: o2, user: r2.getUser() || n2.getUser(), ...s2 && { userAgent: s2 }, ...e2 }), c2 = n2.getSession();
  return c2 && "ok" === c2.status && nt(c2, { status: "exited" }), pn(), n2.setSession(a2), r2.setSession(a2), a2;
}
function pn() {
...
function En(e2, t2, n2 = Mn(e2.bufferSize || 64)) {
  ...
  return { send: function(i2) {
    ...
    return n2.add((() => t2({ body: Ht(s2) }).then(((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && V && Q.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Cn(r2, e3), e3)), ((e3) => {
...
function Nn(e2, t2, n2 = 250, r2, i2, o2, s2) {
  ...
  var c2, l2;
  a2 && (o2.exception.values = (c2 = Rn(e2, t2, i2, s2.originalException, r2, o2.exception.values, a2, 0), l2 = n2, c2.map(((e3) => (e3.value && (e3.value = Ae(e3.value, l2)), e3)))));
}
function Rn(e2, t2, n2, r2, i2, o2, s2, a2) {
  if (o2.length >= n2 + 1) return o2;
  let c2 = [...o2];
  if (Ce(r2[i2], Error)) {
    Fn(s2, a2);
    const o3 = e2(t2, r2[i2]), l2 = c2.length;
    Bn(o3, i2, l2, a2), c2 = Rn(e2, t2, n2, r2[i2], i2, [o3, ...c2], o3, l2);
  }
  return Array.isArray(r2.errors) && r2.errors.forEach(((r3, o3) => {
    if (Ce(r3, Error)) {
      Fn(s2, a2);
      const l2 = e2(t2, r3), u2 = c2.length;
      Bn(l2, `errors[${o3}]`, u2, a2), c2 = Rn(e2, t2, n2, r3, i2, [l2, ...c2], l2, u2);
    }
  })), c2;
}
function Fn(e2, t2) {
  ...
  oe(n2, e2), se(n2, (() => (function(e3, t3 = false) {
    ...
    Le($, "fetch", (function(t4) {
      return function(...n3) {
        ...
        })(n3), s2 = { args: n3, fetchData: { method: i2, url: o2 }, startTimestamp: 1e3 * qe(), virtualError: r2 };
        return e3 || ae("fetch", { ...s2 }), t4.apply($, n3).then((async (t5) => (e3 ? e3(t5) : ae("fetch", { ...s2, endTimestamp: 1e3 * qe(), response: t5 }), t5)), ((e4) => {
          throw ae("fetch", { ...s2, endTimestamp: 1e3 * qe(), error: e4 }), ve(e4) && void 0 === e4.stack && (e4.stack = r2.stack, De(e4, "framesToPop", 1)), e4;
        }));
      };
    }));
  })(void 0, t2)));
...
function ar(e2, t2, n2, r2) {
  ...
  const c2 = { exception: { values: [{ type: ke(t2) ? t2.constructor.name : r2 ? "UnhandledRejection" : "Error", value: gr(t2, { isUnhandledRejection: r2 }) }] }, extra: a2 };
  if (n2) {
    const t3 = lr(e2, n2);
...
function Tr() {
  ...
  br.onpopstate = function(...t3) {
    ...
    kr = n2;
    if (ae("history", { from: r2, to: n2 }), e2) try {
...
function jr() {
  ...
  e2.open = new Proxy(e2.open, { apply(e3, t2, n2) {
    const r2 = new Error(), i2 = 1e3 * qe(), o2 = be(n2[0]) ? n2[0].toUpperCase() : void 0, s2 = (function(e4) {
      if (be(e4)) return e4;
      try {
        return e4.toString();
      } catch (e5) {
    ...
    const a2 = () => {
      ...
      if (e4 && 4 === t2.readyState) {
        ...
        ae("xhr", { endTimestamp: 1e3 * qe(), startTimestamp: i2, xhr: t2, virtualError: r2 });
      }
    };
...
function ea(e2, t2) {
  try {
    var n2 = t2.getState();
    for (var r2 in e2.tracks) if (!ta(r2)) {
      var i2 = e2.tracks[r2].kind;
      if (i2) {
        var o2 = e2.tracks[r2];
        if (o2) {
          var s2 = e2.local ? Xs(n2, r2) : Qs(n2, e2.session_id, r2, i2);
        ...
        var e4 = p((function* () {
          ...
          try {
            for (n2.s(); !(e5 = n2.n()).done; ) {
              ...
              i2 !== oa.get(r2).lastDevicesString && (oa.get(r2).lastDevicesString = i2, r2(t3));
            }
          } catch (e6) {
            n2.e(e6);
          } finally {
      ...
      la.has(e3) && (la.get(e3).lastDevicesString = JSON.stringify(t2), ua || (ua = setInterval(p((function* () {
        ...
        try {
          for (n2.s(); !(e4 = n2.n()).done; ) {
            ...
            i2 !== la.get(r2).lastDevicesString && (la.get(r2).lastDevicesString = i2, r2(t3));
          }
        } catch (e5) {
          n2.e(e5);
        } finally {
...
function cc(e2, t2, n2) {
  var r2, i2 = [];
  e2.video && e2.video.processor && (ps(null !== (r2 = null == t2 ? void 0 : t2.useLegacyVideoProcessor) && void 0 !== r2 && r2) || (e2.video.settings ? delete e2.video.processor : delete e2.video, i2.push("video")));
...
function gc(e2) {
  if (!e2 || e2 && "object" !== n(e2) || Array.isArray(e2)) return console.error(fc()), false;
    ...
    for (var a2 = 0, c2 = Object.entries(e2[s2]); a2 < c2.length; a2++) {
      ...
      switch (u2) {
        ...
        case "sandbox":
          ...
          break;
        case "iconURL":
          if (!U(d2)) return r2(s2, "".concat(u2, " should be a url")), false;
          break;
        case "src":
          if ("srcdoc" in e2[s2]) return r2(s2, "cannot have both src and srcdoc"), false;
          if (!U(d2)) return r2(s2, 'src "'.concat(d2, '" is not a valid URL')), false;
          break;
        case "srcdoc":
...
function mc(e2, t2) {
  ...
  switch (n(t2)) {
    ...
    case "object":
      if ("object" !== n(e2)) return false;
      for (var r2 in e2) if (!mc(e2[r2], t2[r2])) return false;
      return true;
    default:
      return false;
  }
...
var g, m, y, b, _, k, M, C, E, T, O, P, A, j, I, x, L, D, V, J, $, z, W, H, Q, K, Y, X, ee, re, ie, ce, ue, fe, Te, qe, Ye, et, st, lt, ut, dt, St, Ct, xt, Nt, Qt, en, tn, nn, ln, gn, bn, _n, wn, On, An, jn, In, xn, Ln, $n, Gn, er, tr, nr, or, ur, mr, yr, br, _r, wr, Sr, kr, Or, Ar, Lr, Dr, Nr, Rr, Fr, Br, Ur, Vr, Jr, $r, qr, Qr, Kr, Zr, ei, ti, ni, ri, ii, oi, si, ai, ci, li, ui, di, pi, hi, fi, vi, gi, mi, yi, bi, _i, wi, Si, ki, Mi, Ci, Ei, Ti, Oi, Pi, Ai, ji, Ii, xi, Li, Di, Ni, Ri, Fi, Bi, Ui, Vi, Ji, $i, qi, zi, Wi, Hi, Gi, Qi, Ki, Yi, Xi, Zi, eo, to, no, ro, io, oo, so, ao, co, lo, uo, po, ho, fo, vo, go, mo, yo, bo, _o, wo, So, ko, Mo, Co, Eo, To, Oo, Po, Ao, jo, Io, xo, Lo, Do, No, Ro, Fo, Bo, Uo, Vo, Jo, $o, qo, zo, Wo, Ho, Go, Qo, Ko, Yo, Xo, Zo, es, ts, ns, cs, ls, us, ds, Ms, Os, js, Is, xs, Ls, Ds, Us, Vs, Js, $s, qs, zs, Ws, Hs, Gs, Qs, Ks, Ys, Xs, oa, sa, la, ua, fa, ya, ba, _a, wa, Sa, ka, Ma, Ca, Ea, Ta, Oa, La, Da, Na, Ra, Fa, Ba, Ua, Va, Ja, $a, qa, za, Wa, Ha;
  ...
  "node_modules/@daily-co/daily-js/dist/daily-esm.js"() {
    ...
    y = (function() {
      ...
      function c2(e3, t3, n3, r3) {
        ...
        else if ("function" == typeof c3 ? c3 = o3[t3] = r3 ? [n3, c3] : [c3, n3] : r3 ? c3.unshift(n3) : c3.push(n3), (i3 = a2(e3)) > 0 && c3.length > i3 && !c3.warned) {
          c3.warned = true;
      ...
      return Object.defineProperty(i2, "defaultMaxListeners", { enumerable: true, get: function() {
        ...
        var n3, r3, i3, o3, a3;
        if (s2(t3), void 0 === (r3 = this._events)) return this;
        ...
        if (n3 === t3 || n3.listener === t3) 0 == --this._eventsCount ? this._events = /* @__PURE__ */ Object.create(null) : (delete r3[e3], r3.removeListener && this.emit("removeListener", e3, n3.listener || t3));
          ...
          0 === i3 ? n3.shift() : (function(e4, t4) {
            ...
            e4.pop();
          })(n3, i3), 1 === n3.length && (r3[e3] = n3[0]), void 0 !== r3.removeListener && this.emit("removeListener", e3, a3 || t3);
        }
        return this;
    ...
    lt = class _lt {
      ...
      update(e2) {
        if (!e2) return this;
        const t2 = "function" == typeof e2 ? e2(this) : e2, [n2, r2] = t2 instanceof ut ? [t2.getScopeData(), t2.getRequestSession()] : Se(t2) ? [e2, e2.requestSession] : [], { tags: i2, extra: o2, user: s2, contexts: a2, level: c2, fingerprint: l2 = [], propagationContext: u2 } = n2 || {};
    ...
    wn = class {
      ...
      _processEvent(e2, t2, n2) {
        const r2 = this.getOptions(), { sampleRate: i2 } = r2, o2 = kn(e2), s2 = Sn(e2), a2 = e2.type || "error", c2 = `before send for type \`${a2}\``, l2 = void 0 === i2 ? void 0 : (function(e3) {
...
Url: ${Dn(e3)}`), true;
        ...
        t2.console && (function(e4) {
          ...
          return function(n3) {
            ...
            try {
              ...
              r2 = Oe(t4, { keyAttrs: o2, maxStringLength: s2 }), i2 = (function(e6) {
          ...
          return function(t3) {
            ...
            const s2 = Un(r2);
            o2 && o2.path || (o2 = i2), i2.protocol === s2.protocol && i2.host === s2.host && (r2 = s2.relative), i2.protocol === o2.protocol && i2.host === o2.host && (n3 = o2.relative), Pn({ category: "navigation", data: { from: n3, to: r2 } });
          };
        ...
        t2.onerror && (!(function(e4) {
          !(function(e5) {
            ...
            const { msg: i2, url: o2, line: s2, column: a2, error: c2 } = t3, l2 = (function(e5, t4, n3, r3) {
              const i3 = e5.exception = e5.exception || {}, o3 = i3.values = i3.values || [], s3 = o3[0] = o3[0] || {}, a3 = s3.stacktrace = s3.stacktrace || {}, c3 = a3.frames = a3.frames || [], l3 = r3, u2 = n3, d2 = be(t4) && t4.length > 0 ? t4 : (function() {
                try {
              ...
              return e5;
            })(fr(n2, c2 || i2, void 0, r2, false), o2, s2, a2);
    ...
    ei = (e2 = {}) => {
      ...
      return { name: "LinkedErrors", preprocessEvent(e3, r2, i2) {
        ...
        Nn(sr, o2.stackParser, o2.maxValueLength, n2, t2, e3, r2);
      } };
    };
    ti = "new";
    ni = "loading";
    ...
    ds = (function() {
      try {
        ...
        var r2 = null != e2;
        return t2.remove(), r2 ? n2 ? ls : us : cs;
      } catch (e3) {
        return cs;
      }
    })();
    ...
    Os = (function() {
      function e2() {
        var n2, r2, i2, o2;
        return t(this, e2), r2 = this, i2 = a(i2 = e2), (n2 = s(r2, Ts() ? Reflect.construct(i2, o2 || [], a(r2).constructor) : i2.apply(r2, o2)))._wrappedListeners = {}, n2._messageCallbacks = {}, n2;
      }
    ...
    js = (function() {
      function e2() {
        var n2, r2, i2, o2;
        return t(this, e2), r2 = this, i2 = a(i2 = e2), n2 = s(r2, As() ? Reflect.construct(i2, o2 || [], a(r2).constructor) : i2.apply(r2, o2)), global.callMachineToDailyJsEmitter = global.callMachineToDailyJsEmitter || new y.EventEmitter(), global.dailyJsToCallMachineEmitter = global.dailyJsToCallMachineEmitter || new y.EventEmitter(), n2._wrappedListeners = {}, n2._messageCallbacks = {}, n2;
      }
      return l(e2, Ms), o(e2, [{ key: "addListenerForMessagesFromCallMachine", value: function(e3, t2, n2) {
    ...
    Ds = (function() {
      function e2() {
        var n2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r2 = n2.data, i2 = n2.mergeStrategy, o2 = void 0 === i2 ? Is : i2;
    ...
    Js = (function() {
      function e2() {
        return t(this, e2), n2 = this, i2 = arguments, r2 = a(r2 = e2), s(n2, Fs() ? Reflect.construct(r2, i2 || [], a(n2).constructor) : r2.apply(n2, i2));
        var n2, r2, i2;
      }
    ...
    qs = (function() {
      return o((function e3(n2, r2, i2) {
        t(this, e3), this._loadAttemptImpl = is() || !n2.avoidEval ? new zs(n2, r2, i2) : new Ws(n2, r2, i2);
    ...
    Qs = function(e2, t2, n2, r2) {
      var i2 = Ys(e2, t2, n2, r2);
    ...
    ua = null;
    fa = /* @__PURE__ */ new Set();
    ya = Object.freeze({ VIDEO: "video", AUDIO: "audio", SCREEN_VIDEO: "screenVideo", SCREEN_AUDIO: "screenAudio", CUSTOM_VIDEO: "customVideo", CUSTOM_AUDIO: "customAudio" });
    ba = Object.freeze({ PARTICIPANTS: "participants", STREAMING: "streaming", TRANSCRIPTION: "transcription" });
    _a = Object.values(ya);
    wa = ["v", "a", "sv", "sa", "cv", "ca"];
    Object.freeze(_a.reduce((function(e2, t2, n2) {
      return e2[t2] = wa[n2], e2;
    }), {})), Object.freeze(wa.reduce((function(e2, t2, n2) {
      return e2[t2] = _a[n2], e2;
    }), {}));
    Sa = [ya.VIDEO, ya.AUDIO, ya.SCREEN_VIDEO, ya.SCREEN_AUDIO];
    ka = Object.values(ba);
    Ma = ["p", "s", "t"];
    ...
    Ca = (function() {
      ...
      return o(e2, [{ key: "clone", value: function() {
        ...
        if (this.base instanceof Ea ? t2.base = this.base.clone() : t2.base = this.base, void 0 !== this.byUserId) for (var n2 in t2.byUserId = {}, this.byUserId) {
          ...
          t2.byUserId[n2] = r2 instanceof Ea ? r2.clone() : r2;
        }
        ...
        if (void 0 !== this.byParticipantId) for (var r2 in e3.byParticipantId = {}, this.byParticipantId) {
          ...
          e3.byParticipantId[r2] = i2 instanceof Ea ? i2.toJSONObject() : i2;
        }
        return e3;
        ...
        return this.base instanceof Ea && (this.base = this.base.normalize()), this.byUserId && (this.byUserId = Object.fromEntries(Object.entries(this.byUserId).map((function(e3) {
          ...
          return [n2, r2 instanceof Ea ? r2.normalize() : r2];
        ...
        var n2, r2, i2;
        if (void 0 !== t2.base && (n2 = "boolean" == typeof t2.base ? t2.base : Ea.fromJSONObject(t2.base)), void 0 !== t2.byUserId) for (var o2 in r2 = {}, t2.byUserId) {
          var s2 = t2.byUserId[o2];
          r2[o2] = "boolean" == typeof s2 ? s2 : Ea.fromJSONObject(s2);
        }
        ...
        var n2, r2, i2;
        if (void 0 !== t2.b && (n2 = "boolean" == typeof t2.b ? t2.b : Ea.fromMinifiedJSONObject(t2.b)), void 0 !== t2.u) for (var o2 in r2 = {}, t2.u) {
          var s2 = t2.u[o2];
          r2[o2] = "boolean" == typeof s2 ? s2 : Ea.fromMinifiedJSONObject(s2);
        }
        ...
        for (var t2 = ["base", "byUserId", "byParticipantId"], r2 = 0, i2 = Object.keys(e3); r2 < i2.length; r2++) {
          ...
          if ("base" === o2) {
            ...
            for (var l2 = 0, u2 = Object.values(e3[o2]); l2 < u2.length; l2++) {
              var d2 = u2[l2], p2 = f(Ea.validateJSONObject(d2), 2), h2 = p2[0], v2 = p2[1];
    ...
    Ea = (function() {
      ...
      return o(e2, [{ key: "clone", value: function() {
        ...
        for (var r2 = Object.keys(e3), i2 = 0, o2 = r2; i2 < o2.length; i2++) {
          var s2 = o2[i2];
          if (!_a.includes(s2)) return [false, "invalid media type '".concat(s2, "' in canReceive")];
          if (Sa.includes(s2)) {
        ...
        return t2 && r2.length !== _a.length ? [false, 'canReceive "base" permission must specify all media types: '.concat(_a.join(", "), " (or be set to a boolean shorthand)")] : [true];
      } }]);
    })();
    Ta = ["result"];
    Oa = ["preserveIframe"];
    ...
    Da = "video";
    Na = "voice";
    Ra = is() ? { data: {} } : { data: {}, topology: "none" };
    Fa = { present: 0, hidden: 0 };
    Ba = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } };
    Ua = Object.keys(Ba);
    Va = ["state", "volume", "simulcastEncodings"];
    ...
    $a = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string", visualState: "'default' | 'sidebar-open' | 'active'" } };
    qa = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } };
    za = { customIntegrations: { validate: gc, help: fc() }, customTrayButtons: { validate: vc, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify($a)) }, url: { validate: function(e2) {
      ...
      return sc(e2, { allowAllParticipantsKey: false });
    }, help: hc({ allowAllParticipantsKey: false }) }, sendSettings: { validate: function(e2, t2) {
      return !!(function(e3, t3) {
        try {
      ...
      var n2;
      return !!ac(e2) && (t2._inputSettings || (t2._inputSettings = {}), cc(e2, null === (n2 = t2.properties) || void 0 === n2 ? void 0 : n2.dailyConfig, t2._sharedTracks), t2._updatePreloadCacheInputSettings(e2, true), true);
    }, help: pc() }, layout: { validate: function(e2) {
    ...
    Wa = { styles: { validate: function(e2) {
      ...
      for (var t2 = 0, n2 = Object.entries(e2); t2 < n2.length; t2++) {
        ...
        switch (i2) {
          ...
          case "canAdmin":
            if (o2 instanceof Set || o2 instanceof Array || Array.isArray(o2)) {
              var h2, v2 = ["participants", "streaming", "transcription"], g2 = Ia(o2);
              try {
    ...
    Ha = (function() {
      function r2(e2) {
        ...
        if (i3.strictMode = void 0 === h3.strictMode || h3.strictMode, i3.allowMultipleCallInstances = null !== (n2 = h3.allowMultipleCallInstances) && void 0 !== n2 && n2, Object.keys(La).length && (i3._logDuplicateInstanceAttempt(), !i3.allowMultipleCallInstances)) {
      ...
      return l(r2, b), o(r2, [{ key: "destroy", value: (ee2 = p((function* () {
        ...
        return rc(), this.sendMessageToCallMachine({ action: "load-css", cssFile: this.absoluteUrl(n2), bodyClass: t2, cssText: r3 }), this;
        ...
        if (tc(this._callObjectMode, "updateWaitingParticipant()"), Ka(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
        ...
        if (tc(this._callObjectMode, "updateWaitingParticipants()"), Ka(this._callState, "updateWaitingParticipants()"), "object" !== n(t2)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
        ...
        return tc(this._callObjectMode, "requestAccess()"), Ka(this._callState, "requestAccess()"), new Promise((function(t3, n3) {
        ...
        var t2 = this;
        if (tc(this._callObjectMode, "updateReceiveSettings()"), !sc(e2, { allowAllParticipantsKey: true })) throw new Error(hc({ allowAllParticipantsKey: true }));
        return Ka(this._callState, "updateReceiveSettings()", "To specify receive settings earlier, use the receiveSettings config property."), new Promise((function(n2) {
        ...
        if (e2) {
          ...
          if (e2.audio) {
            var r3, i3, o2;
            e2.audio.settings && (!Object.keys(e2.audio.settings).length && t2 || (n2.audio = { settings: Aa({}, e2.audio.settings) })), t2 && null !== (r3 = n2.audio) && void 0 !== r3 && null !== (r3 = r3.settings) && void 0 !== r3 && r3.customTrack && (n2.audio.settings = { customTrack: this._sharedTracks.audioTrack });
        ...
        if (e2.video) {
          var i3, o2, s2;
          if (r3.video = {}, e2.video.settings) r3.video.settings = {}, t2 || e2.video.settings.customTrack || null === (s2 = n2.video) || void 0 === s2 || !s2.settings ? r3.video.settings = e2.video.settings : r3.video.settings = Aa(Aa({}, n2.video.settings), e2.video.settings), Object.keys(r3.video.settings).length || delete r3.video.settings;
        ...
        if (e2.audio) {
          var a2, c3, l2;
          if (r3.audio = {}, e2.audio.settings) r3.audio.settings = {}, t2 || e2.audio.settings.customTrack || null === (l2 = n2.audio) || void 0 === l2 || !l2.settings ? r3.audio.settings = e2.audio.settings : r3.audio.settings = Aa(Aa({}, n2.audio.settings), e2.audio.settings), Object.keys(r3.audio.settings).length || delete r3.audio.settings;
        ...
        var t2 = this;
        return rc(), ac(e2) ? e2.video || e2.audio ? (cc(e2, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(e2, true), this._getInputSettings()) : new Promise((function(n2, r3) {
        ...
        if (rc(), this._callMachineInitialized) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t2, trackConstraints: n2 }), this;
      } }, { key: "getDailyLang", value: function() {
        var e2 = this;
        if (rc(), this._callMachineInitialized) return new Promise((function(t2) {
        ...
        return rc(), this.sendMessageToCallMachine({ action: "set-daily-lang", lang: e2 }), this;
        ...
        var e2 = this;
        return console.warn("getMeetingSession() is deprecated: use meetingSessionSummary(), which will return immediately"), Ka(this._callState, "getMeetingSession()"), new Promise((function(t2) {
        ...
        return new Promise((function(t3) {
          e2._preloadCache.inputSettings = e2._prepInputSettingsForSharing(e2._inputSettings, false), e2.sendMessageToCallMachine({ action: "start-camera", properties: Qa(e2.properties, e2.callClientId), preloadCache: Qa(e2._preloadCache, e2.callClientId) }, (function(e3) {
        ...
        return rc(), Ka(this._callState, "startCustomTrack()"), this.validateCustomTrack(t2.track, t2.mode, t2.trackName), new Promise((function(n2, r3) {
        ...
        var t2 = this;
        return rc(), Ka(this._callState, "stopCustomTrack()"), new Promise((function(n2) {
        ...
        var t2 = this;
        return ic(), Za(this._callMachineInitialized, "setCamera()"), new Promise((function(n2) {
          t2.sendMessageToCallMachine({ action: "set-camera", cameraDeviceId: e2 }, (function(e3) {
            n2({ device: e3.device });
          }));
        }));
      } }, { key: "setAudioDevice", value: (q2 = p((function* (e2) {
        return ic(), this.nativeUtils().setAudioDevice(e2), { deviceId: yield this.nativeUtils().getAudioDevice() };
      })), function(e2) {
        return q2.apply(this, arguments);
        ...
        var e2 = this;
        return ic(), new Promise((function(t2) {
        ...
        if (rc(), void 0 !== i3 && (n2 = i3), void 0 !== o2 && (r3 = o2), "boolean" == typeof n2 && (this._setAllowLocalAudio(n2), n2 = void 0), "boolean" == typeof r3 && (this._setAllowLocalVideo(r3), r3 = void 0), !n2 && !r3) return yield this.getInputDevices();
        var s2 = {};
        return n2 && (n2 instanceof MediaStreamTrack ? (this._sharedTracks.audioTrack = n2, n2 = Qo, s2.audio = { settings: { customTrack: n2 } }) : (delete this._sharedTracks.audioTrack, s2.audio = { settings: { deviceId: n2 } })), r3 && (r3 instanceof MediaStreamTrack ? (this._sharedTracks.videoTrack = r3, r3 = Qo, s2.video = { settings: { customTrack: r3 } }) : (delete this._sharedTracks.videoTrack, s2.video = { settings: { deviceId: r3 } })), this._callObjectMode && this.needsLoad() ? (this._updatePreloadCacheInputSettings(s2, false), this._devicesFromInputSettings(this._inputSettings)) : new Promise((function(e3) {
        ...
        if (rc(), !n2 || "string" != typeof n2) throw new Error("outputDeviceId must be provided and must be a valid device id");
        ...
        if (ic(), [Da, Na].includes(e2)) {
          if (e2 !== this._nativeInCallAudioMode) return this._nativeInCallAudioMode = e2, !this.disableReactNativeAutoDeviceManagement("audio") && Ya(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
        } else console.error("invalid in-call audio mode specified: ", e2);
      } }, { key: "preAuth", value: (U2 = p((function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (tc(this._callObjectMode, "preAuth()"), Xa(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t2)), !t2.url) throw new Error("preAuth() requires at least a url to be provided");
        return this.validateProperties(t2), this.properties = Aa(Aa({}, this.properties), t2), new Promise((function(t3, n2) {
          e2._preloadCache.inputSettings = e2._prepInputSettingsForSharing(e2._inputSettings, false), e2.sendMessageToCallMachine({ action: "daily-method-preauth", properties: Qa(e2.properties, e2.callClientId), preloadCache: Qa(e2._preloadCache, e2.callClientId) }, (function(r3) {
        ...
        if (this.needsLoad()) {
          ...
          return this._updateCallState(ni), this.emitDailyJSEvent({ action: Vi }), this._callObjectMode ? new Promise((function(e3, n2) {
            ...
            t2._loadedCallback = function(r3) {
              t2._callState !== ai ? (t2._updateCallState(ri), (t2.properties.cssFile || t2.properties.cssText) && t2.loadCss(t2.properties), e3()) : n2(r3);
            };
          })));
        }
      })), function(e2) {
        ...
        return void 0 !== t2.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t2.showLocalVideo), void 0 !== t2.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t2.showParticipantsBar), this._callState === oi || this._callState === ii ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false)) : (this._updateCallState(ii, false), this.emitDailyJSEvent({ action: Wi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, false), this.sendMessageToCallMachine({ action: "join-meeting", properties: Qa(this.properties, this.callClientId), preloadCache: Qa(this._preloadCache, this.callClientId) }), new Promise((function(t3, r3) {
        ...
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (Za(this._callMachineInitialized, "startScreenShare()"), t2.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t2.screenVideoSendSettings), t2.mediaStream && (this._sharedTracks.screenMediaStream = t2.mediaStream, t2.mediaStream = Qo), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
        ...
        Za(this._callMachineInitialized, "stopScreenShare()"), this.sendMessageToCallMachine({ action: "local-screen-stop" });
        ...
        if (e2) {
          ...
          if (!_c(e2.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
          for (var r3 = 0; r3 < e2.length; r3++) {
            ...
            for (var o2 in this._validateEncodingLayerHasValidProperties(i3), i3) if (Ua.includes(o2)) {
              ...
              if (t2) {
                ...
                if (!_c(i3[o2], a2, c3)) throw new Error("".concat(o2, " value not in range. valid range: ").concat(a2, " to ").concat(c3));
              }
        ...
        Ka(this._callState, "startTranscription()"), this.sendMessageToCallMachine(Aa({ action: "daily-method-start-transcription" }, e2));
      } }, { key: "updateTranscription", value: function(e2) {
        if (Ka(this._callState, "updateTranscription()"), !e2) throw new Error("updateTranscription Error: options is mandatory");
        ...
        if (Ka(this._callState, "stopTranscription()"), e2 && "object" !== n(e2)) throw new Error("stopTranscription Error: options must be object type");
        ...
        if (Ga(e2), e2.permissions && e2.permissions.canReceive) {
          var r3 = f(Ca.validateJSONObject(e2.permissions.canReceive), 2), i3 = r3[0], o2 = r3[1];
        ...
        var t2 = this;
        return Ka(this._callState, "stopDialOut()"), new Promise((function(n2, r3) {
        ...
        var t2 = this;
        if (Ka(this._callState, "sipCallTransfer()"), !e2) throw new Error("sipCallTransfer() requires a sessionId and toEndPoint");
        return e2.useSipRefer = false, yc(e2, "sipCallTransfer"), Ga(e2), new Promise((function(n2, r3) {
        ...
        var t2 = this;
        if (Ka(this._callState, "sipRefer()"), !e2) throw new Error("sessionId and toEndPoint are mandatory parameter");
        return e2.useSipRefer = true, yc(e2, "sipRefer"), new Promise((function(n2, r3) {
          t2.sendMessageToCallMachine(Aa({ action: ns }, e2), (function(e3) {
            e3.error ? r3(e3.error) : n2(e3);
          }));
        }));
        ...
        var t2 = this;
        return Ka(this._callState, "sendDTMF()"), (function(e3) {
        ...
        var t2 = this;
        rc(), tc(this._callObjectMode, "testCallQuality()"), Za(this._callMachineInitialized, "testCallQuality()", null, true), Xa(this._callState, this._isPreparingToJoin, "testCallQuality()");
        ...
        return rc(), this.sendMessageToCallMachine({ action: "set-active-speaker-mode", enabled: e2 }), this;
        ...
        return Ka(this._callState, "setSubscribeToTracksAutomatically()", "Use the subscribeToTracksAutomatically configuration property."), this._preloadCache.subscribeToTracksAutomatically = e2, this.sendMessageToCallMachine({ action: "daily-method-subscribe-to-tracks-automatically", enabled: e2 }), this;
        ...
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
        if (Ka(this._callState, "sendAppMessage()"), JSON.stringify(e2).length > this._maxAppMessageSize) throw new Error("Message data too large. Max size is " + this._maxAppMessageSize);
        return this.sendMessageToCallMachine({ action: "app-msg", data: e2, to: t2 }), this;
      } }, { key: "addFakeParticipant", value: function(e2) {
        return rc(), Ka(this._callState, "addFakeParticipant()"), this.sendMessageToCallMachine(Aa({ action: "add-fake-participant" }, e2)), this;
      } }, { key: "setShowNamesMode", value: function(e2) {
        return nc(this._callObjectMode, "setShowNamesMode()"), rc(), e2 && "always" !== e2 && "never" !== e2 ? (console.error('setShowNamesMode argument should be "always", "never", or false'), this) : (this.sendMessageToCallMachine({ action: "set-show-names", mode: e2 }), this);
      } }, { key: "setShowLocalVideo", value: function() {
        var e2 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
        return nc(this._callObjectMode, "setShowLocalVideo()"), rc(), Ka(this._callState, "setShowLocalVideo()"), "boolean" != typeof e2 ? (console.error("setShowLocalVideo only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-local-video", show: e2 }), this._showLocalVideo = e2, this);
        ...
        var e2 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
        return nc(this._callObjectMode, "setShowParticipantsBar()"), rc(), Ka(this._callState, "setShowParticipantsBar()"), "boolean" != typeof e2 ? (console.error("setShowParticipantsBar only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-participants-bar", show: e2 }), this._showParticipantsBar = e2, this);
        ...
        return rc(), nc(this._callObjectMode, "setCustomIntegrations()"), Ka(this._callState, "setCustomIntegrations()"), gc(e2) ? (this.sendMessageToCallMachine({ action: "set-custom-integrations", integrations: e2 }), this._customIntegrations = e2, this) : this;
      } }, { key: "startCustomIntegrations", value: function(e2) {
        var t2 = this;
        if (rc(), nc(this._callObjectMode, "startCustomIntegrations()"), Ka(this._callState, "startCustomIntegrations()"), Array.isArray(e2) && e2.some((function(e3) {
          return "string" != typeof e3;
        ...
        var t2 = this;
        if (rc(), nc(this._callObjectMode, "stopCustomIntegrations()"), Ka(this._callState, "stopCustomIntegrations()"), Array.isArray(e2) && e2.some((function(e3) {
          return "string" != typeof e3;
        ...
        return nc(this._callObjectMode, "updateCustomTrayButtons()"), rc(), Ka(this._callState, "updateCustomTrayButtons()"), vc(e2) ? (this.sendMessageToCallMachine({ action: "update-custom-tray-buttons", btns: e2 }), this._customTrayButtons = e2, this) : (console.error("updateCustomTrayButtons only accepts a dictionary of the type ".concat(JSON.stringify($a))), this);
      } }, { key: "theme", value: function() {
        return nc(this._callObjectMode, "theme()"), this.properties.theme;
      } }, { key: "setTheme", value: function(e2) {
        var t2 = this;
        return nc(this._callObjectMode, "setTheme()"), new Promise((function(n2, r3) {
          try {
        ...
        var t2 = this;
        return rc(), Ka(this._callState, "setNetworkTopology()"), new Promise((function(n2, r3) {
        ...
        if (rc(), "number" != typeof e2 && true !== e2 && false !== e2) throw new Error("argument to setShouldPlayNewParticipantSound should be true, false, or a number, but is ".concat(e2));
        ...
        if (null != e2 && null !== (t2 = e2.dailyConfig) && void 0 !== t2 && t2.userMediaAudioConstraints) {
          ...
          o2.audio = (null === (r3 = e2.inputSettings) || void 0 === r3 ? void 0 : r3.audio) || {}, o2.audio.settings = (null === (i3 = e2.inputSettings) || void 0 === i3 || null === (i3 = i3.audio) || void 0 === i3 ? void 0 : i3.settings) || {}, o2.audio.settings = Aa(Aa({}, o2.audio.settings), e2.dailyConfig.userMediaAudioConstraints), e2.inputSettings = o2, delete e2.dailyConfig.userMediaAudioConstraints;
        }
        ...
        var e2, t2, n2 = Aa(Aa({}, this.properties), {}, { emb: this.callClientId, embHref: encodeURIComponent(window.location.href), proxy: null !== (e2 = this.properties.dailyConfig) && void 0 !== e2 && e2.proxyUrl ? encodeURIComponent(null === (t2 = this.properties.dailyConfig) || void 0 === t2 ? void 0 : t2.proxyUrl) : void 0 }), r3 = n2.url.match(/\?/) ? "&" : "?";
        return n2.url + r3 + Object.keys(za).filter((function(e3) {
        ...
        switch (t2.action) {
          ...
          case to:
            ...
            this._meetingSessionState = wc(t2.meetingSessionState, this._callObjectMode), (this._callObjectMode || M3) && this.emitDailyJSEvent(t2);
            break;
          case ko:
        ...
        if (e2 !== this._callState || t2 !== this._isPreparingToJoin) {
          ...
          var o2 = Ya(n2, r3), s2 = Ya(this._callState, this._isPreparingToJoin);
        ...
        this._participants = {}, this._participantCounts = Fa, this._waitingParticipants = {}, this._activeSpeaker = {}, this._activeSpeakerMode = false, this._didPreAuth = false, this._accessState = { access: fi }, this._finalSummaryOfPrevSession = this._meetingSessionSummary, this._meetingSessionSummary = {}, this._meetingSessionState = wc(Ra, this._callObjectMode), this._isScreenSharing = false, this._receiveSettings = {}, this._inputSettings = void 0, this._sendSettings = {}, this._localAudioLevel = 0, this._isLocalAudioLevelObserverRunning = false, this._remoteParticipantsAudioLevel = {}, this._isRemoteParticipantsAudioLevelObserverRunning = false, this._maxAppMessageSize = $o, this._callMachineInitialized = false, this._bundleLoadTime = void 0, this._preloadCache;
        ...
        })), f2 = new mr({ dsn: "https://f10f1c81e5d44a4098416c0867a8b740@o77906.ingest.sentry.io/168844", transport: Ir, stackParser: Br, integrations: h3, environment: a2 }), v3 = new ut();
        ...
        v3.setTags({ callMode: this._callObjectMode ? is() ? "reactNative" : null !== (i3 = this.properties) && void 0 !== i3 && null !== (i3 = i3.dailyConfig) && void 0 !== i3 && null !== (i3 = i3.callMode) && void 0 !== i3 && i3.includes("prebuilt") ? this.properties.dailyConfig.callMode : "custom" : "prebuilt-frame", version: r2.version() });
        ...
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (rc(), !e2 || !e2.contentWindow || "string" != typeof e2.src) throw new Error("DailyIframe::Wrap needs an iframe-like first argument");
        return t2.layout || (t2.customLayout ? t2.layout = "custom-v1" : t2.layout = "browser"), new r2(e2, t2);
      } }, { key: "createFrame", value: function(e2, t2) {
        var n2, i3;
        rc(), e2 && t2 ? (n2 = e2, i3 = t2) : e2 && e2.append ? (n2 = e2, i3 = {}) : (n2 = document.body, i3 = e2 || {});
      ...
      constructor(apiConfig = {}) {
        ...
        __publicField(this, "request", async ({ body, secure, path, type, query, format, baseUrl, cancelToken, ...params }) => {
          ...
          return this.customFetch(`${baseUrl || this.baseUrl || ""}${path}${queryString ? `?${queryString}` : ""}`, {
            ...
            const data = !responseFormat ? r2 : await responseToParse[responseFormat]().then((data2) => {
              if (r2.ok) {
                r2.data = data2;
              } else {
                r2.error = data2;
        ...
        try {
          ...
          this.emit("call-start-progress", {
            ...
            metadata: {
              ...
              videoRecordingEnabled: ((_a2 = webCall == null ? void 0 : webCall.artifactPlan) == null ? void 0 : _a2.videoRecordingEnabled) ?? false,
              voiceProvider: ((_c2 = (_b = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _b.voice) == null ? void 0 : _c2.provider) || "unknown"
            }
          });
          if (this.call) {
            this.emit("call-start-progress", {
          ...
          const isVideoRecordingEnabled = ((_d = webCall == null ? void 0 : webCall.artifactPlan) == null ? void 0 : _d.videoRecordingEnabled) ?? false;
          const isVideoEnabled = ((_f = (_e2 = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _e2.voice) == null ? void 0 : _f.provider) === "tavus";
          this.emit("call-start-progress", {
            stage: "daily-call-object-creation",
            status: "started",
            timestamp: (/* @__PURE__ */ new Date()).toISOString(),
          ...
          (_g = this.call.iframe()) == null ? void 0 : _g.style.setProperty("display", "none");
          ...
          const totalDuration = Date.now() - startTime;
          const serializedError = serializeError(e2);
      ...
      async reconnect(webCall) {
        ...
        this.emit("call-start-progress", {
          ...
          metadata: {
            ...
            hasVideoRecording: !!((_a2 = webCall == null ? void 0 : webCall.artifactPlan) == null ? void 0 : _a2.videoRecordingEnabled),
            voiceProvider: ((_c2 = (_b = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _b.voice) == null ? void 0 : _c2.provider) || "unknown"
          }
        });
        this.started = true;
        try {
          ...
          this.emit("call-start-failed", {
            ...
            context: {
              isReconnect: true,
              callId: (webCall == null ? void 0 : webCall.id) || "unknown",
              hasVideoRecording: !!((_h = webCall == null ? void 0 : webCall.artifactPlan) == null ? void 0 : _h.videoRecordingEnabled),
              voiceProvider: ((_j = (_i2 = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _i2.voice) == null ? void 0 : _j.provider) || "unknown",
              isMobile: this.isMobileDevice()
            }
          });
          this.emit("error", {
            ...
            context: {
              isReconnect: true,
              callId: (webCall == null ? void 0 : webCall.id) || "unknown",
              hasVideoRecording: !!((_k = webCall == null ? void 0 : webCall.artifactPlan) == null ? void 0 : _k.videoRecordingEnabled),
              voiceProvider: ((_m = (_l = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _l.voice) == null ? void 0 : _m.provider) || "unknown",
              isMobile: this.isMobileDevice()
            }
          });
          await this.cleanup();
